module.exports = function(RED) {
    class QbusDimmerNode {
        ...
        onStateUpdate(state) {
            ...
            if (state.state === true){
                ...
                node.status({fill:"red", shape:"dot", text:"Connected with MQTT Server, but no controller selected."});
    ...
    RED.nodes.registerType("qbus-dimmer",QbusDimmerNode);
}